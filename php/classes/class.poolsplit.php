...
/*
    Class representation of the dividing of the weekly and final pools.
*/

class PoolSplit extends RecordSet
{
    var $tableName;
//
    ...
    function PoolSplit($leagueName, $leagueYear) 
    {
        $this->tableName = CreateTableName(POOL_SPLIT_TABLE_NAME, $leagueName, $leagueYear);
    }
    ...
    */
    ...
    function CalculatePrizes($scores, $prize) 
    {
        ...
        while ($payoutIndex < count($scores)) 
        {
            ...
            {
                $val = $prize * $breakDowns[$payoutIndex] / 100;
                $pool[] = $val;
            }
    ...
    /*
        ...
        Paramaters:     scores  -- Array of scores

        Description:    Does the actual splitting of the pool based on scores
